...
class MinecraftLauncher:
    def __init__(self):
        ...
        self.PMCL_Menu = tk.Frame(background="gray")
        self.PMCL_Download = tk.Frame(background="gray")
        self.PCML_Download_Log = tk.Text(background="gray")
        ...
        self.version_list = tk.Listbox(self.PMCL_Download)
        ...
        tk.Button(self.PMCL_Download, command=self.download_minecraft_version, text="下载选中版本").pack(side="right")

        self.minecraft_version_list = os.listdir(".minecraft/versions")
        self.vl = tk.Listbox(self.PMCL_Menu, background="skyblue")
        ...
        self.steve = tk.Label(self.PMCL_Menu, image=photo)
        self.steve.pack(pady=150)
        style = ttk.Style()
        ...
        style.configure('RoundedButton.TButton',
                        ...
                        borderwidth=0,
                        relief=tk.RAISED)
        self.username = tk.Entry(self.PMCL_Menu)
        self.username.pack()
        self.start = ttk.Button(self.PMCL_Menu, text="启动选中的游戏", style='RoundedButton.TButton', command=self.get_version_to_start)
        self.start.pack()
        self.PMCL.mainloop()

    def set_status(self, status: str):
        self.PCML_Download_Log.insert(tk.END, f"\n{status}")
                ...
                def download_choose():
                    ...
                    try:
                        if a.get() == "Minecraft Forge":
                            ...
                            mclib.forge.install_forge_version(mclib.forge.list_forge_versions()[0], self.minecraft_dir_path,
